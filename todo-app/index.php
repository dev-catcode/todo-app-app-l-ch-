<?php
/* =========================================
 * TRANG CHỦ (INDEX.PHP) - DASHBOARD
 * ========================================= */

require_once 'auth_check.php'; 

try {
    // Sắp xếp: task chưa xong lên đầu, ưu tiên theo ngày hết hạn
    $stmt = $pdo->prepare("SELECT * FROM tasks WHERE user_id = ? ORDER BY status ASC, due_date ASC, created_at DESC");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <i class="fa-solid fa-list-check"></i> ToDo App
            </a>
                    ...
                    <div class="card-body">
                        ...
                        <?php if (empty($tasks)): ?>
                            <div class="alert alert-info text-center">
                                ...
                                <p class="mb-0">Tuyệt vời! Bạn không có công việc nào cần làm.</p>
                            </div>
                        <?php else: ?>
                            <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center 
                                        ...
                                        <div class="text-nowrap">
                                            ...
                                            <?php if ($task['status'] == 'completed'): ?>
                                                <a href="update_status.php?id=<?php echo $task['id']; ?>&status=pending"
                                                   class="btn btn-warning btn-sm" title="Đánh dấu Chưa hoàn thành">
                                                    <i class="fa-solid fa-arrow-rotate-left"></i>
                                                </a>
                                            <?php else: ?>
                                                <a href="update_status.php?id=<?php echo $task['id']; ?>&status=completed"
                                                   class="btn btn-success btn-sm" title="Đánh dấu Hoàn thành">
